...
if auth_status:
    ...
    if "raw_text" not in st.session_state:
        ...
        with open('raw_text.pkl', 'wb') as raw_text_file:
            pickle.dump(raw_text, raw_text_file)
        with open('text_chunks.pkl', 'wb') as text_chunks_file:
            pickle.dump(text_chunks, text_chunks_file)
        with open('vectorstore.pkl', 'wb') as vectorstore_file:
            pickle.dump(vectorstore, vectorstore_file)
