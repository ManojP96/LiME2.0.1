...
def chatbot():
    ...
    #         st.session_state['pdf_docs'] = pdf_content  

    with open('raw_text.pkl', 'rb') as raw_text_file:
        raw_text = pickle.load(raw_text_file)
        st.session_state['raw_text'] = raw_text
    # Read text chunks from the saved file
    with open('text_chunks.pkl', 'rb') as text_chunks_file:
        text_chunks = pickle.load(text_chunks_file)
        st.session_state['text_chunks'] = text_chunks

    # Read vectorstore from the saved file
    with open('vectorstore.pkl', 'rb') as vectorstore_file:
        vectorstore = pickle.load(vectorstore_file)
